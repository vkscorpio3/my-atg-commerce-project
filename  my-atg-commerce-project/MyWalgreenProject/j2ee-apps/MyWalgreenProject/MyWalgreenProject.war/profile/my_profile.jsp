...
<b>My Profile </b>
<hr size=0>
<dsp:a href="includes/cart.jsp" >Cart( <dsp:valueof bean="/atg/commerce/ShoppingCart.current.TotalCommerceItemCount"></dsp:valueof> )</dsp:a>
&nbsp;<dsp:a href="../home.jsp">Catalog</dsp:a>
&nbsp;<dsp:a href="order_history.jsp">My Oders</dsp:a>
<hr size=0>
...
<dsp:form action="home.jsp" method="POST">
    ...
    <dsp:oparam name="true">
     <dsp:droplet name="/atg/dynamo/droplet/Redirect">
          <dsp:param value="../home.jsp" name="url"/>
        </dsp:droplet>
    </dsp:oparam>
